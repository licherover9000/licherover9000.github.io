...
accents): six projects across mobile apps and data analytics, plus a hand-built blog.
...
| `blog/` | The blog — `index.html` is the post list; each post is one HTML file named `YYYY-MM-DD-slug.html` |
